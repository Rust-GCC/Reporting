...
On the other hand, this macro is perfectly valid since a comma, contained in the follow-set of ~:expr~, is required to appear before any forbidden tokens
...
An interesting tidbit 3/ why expansion instead of parsing

# garabage While rust macros are extremely powerful, they also contain a wide set of restrictions to ensure a lack of ambiguity and a high amount of quality.
