#+title:  Weekly report for 9th of September to 16th of September 2024
...
- RustConf was a great event and it was really nice to talk to the american side of the Rust community
  - Great interactions with people from different teams and working on different issues
  - First draft for rust-lang.org blogpost is done and under review, will be sent to the Rust council for reviewing
- Pierre-Emmanuel gave a great talk at Cauldron
- Pattern analysis has been merged
  - This paves the way for exhaustive matches and all those errors
  - Very complex analysis done by one of our old GSoC contribuors (tamaroning)
- Some typechecking errors

** Completed Activities

- Emit error on auto-traits                               [[https://github.com/rust-gcc/gccrs/pull/3159][PR3159]]
- session-manager: Fix typos in -frust-incomplete message [[https://github.com/rust-gcc/gccrs/pull/3153][PR3153]]
- Compile using ASAN on the github CI                     [[https://github.com/rust-gcc/gccrs/pull/3142][PR3142]]
- Dynamic dispatch with supertraits                       [[https://github.com/rust-gcc/gccrs/pull/3124][PR3124]]
- pattern analysis                                        [[https://github.com/rust-gcc/gccrs/pull/3115][PR3115]]

*** Contributors this week

- [[https://github.com/Kamiinarii78][Benjamin Thos]] (new contributor!)
...
| Inline assembly                   |        70% |       100% |  +30% |  1st Jun 2024 |               - | 15th Sep 2024 |   GCC 15.1 |
