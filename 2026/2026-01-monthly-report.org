...
*very technical mumbo jumbo*

This helps provide better errors and improves the API for later passes of the compiler, such as late name resolution and type-checking.

Another interesting discovery this month is this hack taken directly from ~rustc~:
