#+title:  Weekly report for 11th of May to 18th of May 2026
...
- GSOC students have been selected, welcome Janet and Enes!
  - Starting community bonding period
  - Work is starting on the 25th
- Contract renewed with Brad
- Our EuroRust talk got accepted
  - In Barcelona, Spain
  - One month after RustConf so the content will be the same
  - This was explicitly mentioned in our abstract
- One regression on master that we are investigating, might be the CI acting up
