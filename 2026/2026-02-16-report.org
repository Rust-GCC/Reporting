#+title:  Weekly report for 9th of February to 16th of February 2026
...
- Work continues on fixing import NR issues for ~core~
- Big rework of attributes from Pierre-Emmanuel which enables a more thorough visit of them
  - Finally being treated as actual nodes
  - Which means an AST rework with lots of catches
- Working on CfP for RustConf which needs to be submitted by tomorrow
  - Almost complete so no worries
