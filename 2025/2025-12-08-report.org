#+title:  Weekly report for 1st of December to 8th of December 2025
...
- Sending continuing contract later today
- Massive progress on ~core~ with early name resolution working
  - This means that all our efforts in rewriting nameres the last two years have paid off
  - Macro expansion, early nameres which includes import resolution etc fully working
  - A few remaining issues with late name resolution which will be fixed before the end of the year
  - Really good progress for compiling RfL
- Still keeping up to date with upstreaming and syncing with upstream
