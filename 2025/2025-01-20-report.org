#+title:  Weekly report for 13th of January to 20th of January 2025
...
- Just like last week, lots of work on three main milestones at the moment
  - Auto traits
    - They are done, waiting in review
    - We can just handle correct code and do not take care of invalid uses, which is wrong but not problematic for ~core~.
  - Remaining built-in derive macros
    - Still hammering at them, opened up good first issue for them
    - Will take care of the remaining comparison derives as they are super important
  - More lang item stuff
    - That has been finally merged and they are in a good place now
  - A lot of type system and codegen fixes by Philip
  - Some more name resolution fixes
    - Massive feature being worked on by PE, which is closure capture 
    - This is extremely important for feature parity between the two algorithms
- Starting work on error propagation expressions
