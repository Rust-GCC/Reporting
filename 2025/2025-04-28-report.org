...
- Release is now completely done
- trunk has been unfrozen and we can now push patches again
  - We'll resume upstreaming today
- Still improving our git processes, currently updating our fork's base to integrate the latest trunk changes
- Trying to see if we can get the release managers to allow us pushing patches into 15.2
- We'll spend some time on blogposts and planning
  - 15.1 release blogpost
  - 15.2 and 16.1 milestones preparation
- Currently selecting GSoC candidates, two good proposals
...
- nr2.0: Fix multiple bindings                            [[https://github.com/rust-gcc/gccrs/pull/3702][PR3702]]
...
|-------------+------------+------------+-------|
| TODO        |        493 |        477 |   -16 |
| In Progress |        119 |        114 |    -5 |
| Completed   |       1035 |       1055 |   +20 |
...
| Macro expansion                   |        90% |       100% |   +4% |  1st Jun 2024 |               - |  1st Jan 2025 |   GCC 15.1 |
...
| let-else                          |        60% |       100% |  +40% | 28th Jan 2025 |               - | 28th Feb 2025 |   GCC 15.1 |
